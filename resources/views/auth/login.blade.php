        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="con">
                ...
                <div class="field-set">
                    ...
                    <input class="form-input" type="password" required autocomplete="current-password"
                        placeholder="Mot de passe" id="pwd" name="password">
                    <span>
                    ...
                    <div class="block mt-4">
                        <label for="remember_me" class="inline-flex items-center">
                            <input id="remember_me" type="checkbox"
                                class="rounded border-danger-600 text-indigo-600 shadow-sm focus:ring-indigo-500"
                                name="remember">
                            <span class="ml-2 text-sm" style="color: blue;">Se souvenir de moi</span>
                        </label>
                    </div>
                    <a class="frgt-pass text-danger" href="{{ route('password.request') }}">Mot de passe oublié
                        ?</a></br>
                    @if (\App\Models\User::where('role', 'super-admin')->count() > 0)
                    @else
                        <a href="{{ route('register') }}" class="sign-up"><i class="fa fa-user-plus"
                                aria-hidden="true"></i>Créer un compte
                        </a>
                    @endif
                </div>
            </div>
