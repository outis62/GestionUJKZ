        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            <div class="small-box bg-white">
              ...
              <a href="{{route('ListeFiliere')}}" class="small-box-footer text-white">Voir plus <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <div class="col-lg-3 col-6">
            <div class="small-box bg-white">
              ...
              <a href="{{route('listematiere')}}" class="small-box-footer text-white">Voir plus <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <div class="col-lg-3 col-6">
            <div class="small-box bg-white">
              ...
              <a href="javascript:void(0);" class="small-box-footer text-white">Voir plus <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <div class="col-lg-3 col-6">
            <div class="small-box bg-white">
        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            <div class="small-box bg-white">
              ...
              <a href="{{route('adminliste')}}" class="small-box-footer text-white">Voir plus <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <div class="col-lg-3 col-6">
            <div class="small-box bg-white">
              ...
              <a href="{{route('enseignant')}}" class="small-box-footer text-white">Voir plus <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <div class="col-lg-3 col-6">
            <div class="small-box bg-white">
              ...
              <a href="{{route('store')}}" class="small-box-footer text-white">Voir plus <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <div class="col-lg-3 col-6">
            <div class="small-box bg-white">
