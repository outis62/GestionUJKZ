		...
		<div class="container">
			<div class="row text-center text-xs-center text-sm-left text-md-left">
				<div class="col-xs-12 col-sm-4 col-md-4">
					<a href="javascript:void();" ><img src="{{asset('dist/img/logobu2.png')}}" width="100" height="100" alt="LogoBU"></a>
                    <p class="text-white">La technologie au service de l'education.</p>
				</div>
				<div class="col-xs-12 col-sm-4 col-md-4">
					<h5 class="fw-bold" style="color: lightseagreen;">Menu</h5>
					<ul class="list-unstyled quick-links">
						...
						<li><a href="javascript:void();"><i class="fa fa-angle-double-right"></i>Formations</a></li>
						<li><a href="javascript:void();"><i class="fa fa-angle-double-right"></i>Services</a></li>
                        <li><a href="javascript:void();"><i class="fa fa-angle-double-right"></i>FAQ</a>  <a href="javascript:void();"><i class="fa fa-angle-double-right"></i>Contacts</a></li>
				...
				<div class="col-xs-12 col-sm-4 col-md-4">
					...
					<ul class="list-unstyled quick-links">
						<li><a href="javascript:void();"><i class="fa fa-angle-double-right"></i>Gestion centralisee</a></li>
