...
<html lang="fr">
                ...
                <nav class="navbar navbar-expand-lg navbar-light window-scroll">
                  <div class="container-fluid">
                    <a class="navbar-brand" href="/">
                      <h4 class="buluni text-white fw-bold">BULLETIN-UNIV</h4>
                    </a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                      <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                          <a class="btn btn-md btn-outline-primary" style="margin-left:110px!important" type="button"  href="{{route('login')}}">Connexion</a>
                        </li>
                      </ul>
                    </div>
                  </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6">
                ...
                <a href="javascript:void(0);" type="button" class="btn btn-secondary p-3 downloadbuton"><img src="{{asset('dist/img/playstore.png')}}" width="120" height="35" alt=""></a>
  ...
  <div class="row">
    ...
    <img src="{{asset('dist/img/computer2.svg')}}" width="60" height="50" class="mt-3" alt="computer">
                ...
                <p>tincidunt sit malesuada laoreet vel suscipit Morbi eu sapien suscipit </p>
                <a href="javascript:void();" type="button" class="btn btn-secondary p-1 voirplus">Voir plus<i class="fas fa-arrow-circle-right"></i></a>
    </div>
