  ...
  <div class="row">
          <div class="col-lg-12 col-12">
            <div class="bg-white boardaccueil">
              ...
              <div class="mt-4" style="margin-left: 170px!important;"><a type="btn" class="btn btn-primary" href="{{route('listecycle')}}">Liste <i class="fa fa-book"></i></a>   <a type="btn" class="btn btn-secondary" href="javascript:void(0);"><i class="fa fa-backward"></i> Retour</a></div>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-12 col-12">
            <div class="small-box bg-white boardaccueil">
              <div class="inner ms-3">
                ...
                @csrf
                  <input type="text" class="form-control d-inline" name="cycle" placeholder="Saisir cycle" style="background-color: white; margin-bottom: 10px; color: black;" required>
