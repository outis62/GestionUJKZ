                ...
                <div class="col-lg-12 col-12">
                    <div class="bg-white boardaccueil">
                        ...
                        <div class="mt-4" style="margin-left: 170px!important;"><a type="btn" class="btn btn-primary"
                                href="{{ route('ListeFiliere') }}">Liste <i class="fa fa-book"></i></a> <a type="btn"
                    ...
                    <div class="small-box bg-white boardaccueil">
                        <div class="inner ms-3">
                            ...
                            <form action="{{ route('ajoutfiliere') }}" method="POST">
                                @csrf
                                <input type="text" class="form-control d-inline" name="filiere"
                                    placeholder="Saisir nouvelle filière"
