        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12 col-12">
                    <a href="{{ route('semestre') }}" type="button" class="btn btn-primary">Ajouter un niveau semestre</a>
                                    ...
                                    @foreach ($semestre as $semestre)
                                        <tr>
                                            ...
                                            <td style="width: 130px;">
                                                <a href="#deleteEmployeeModal{{ $semestre->id }}"
                                                    class="delete btn btn-danger d-inline mt-1" data-toggle="modal"><i
                                                        class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
                                        <div id="deleteEmployeeModal{{ $semestre->id }}" class="modal fade">
                                            <div class="modal-dialog">
                                                <div class="modal-content" style="background: white">
                                                    <form action="{{ route('supprimersemestre', $semestre->id) }}">
                                                        ...
                                                        <div class="modal-body">
                                                            <p class="text-danger">Voulez-vous vraiment supprimer le
                                                                semestre <span
                                                                    class="text-info">{{ $semestre->semestre }}</span>
                                                                ?
                                                            </p>
                    ...
                    @else
                        <div class="small-box bg-white mt-5">
                            <div class="inner ms-3">
                                <p class="fs-6 text-warning text-center">Aucun semestre constaté pour le moment
                                    🎡</p>
                            </div>
                        </div>
                    @endif
