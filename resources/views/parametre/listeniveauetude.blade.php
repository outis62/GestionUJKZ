                                    ...
                                    @foreach ($niveauetude as $niveauetude)
                                        <tr>
                                            ...
                                            <td style="width: 130px;">
                                                <a href="#deleteEmployeeModal{{ $niveauetude->id }}"
                                                    class="delete btn btn-danger d-inline mt-1" data-toggle="modal"><i
                                                        class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
                                        <div id="deleteEmployeeModal{{ $niveauetude->id }}" class="modal fade">
                                            <div class="modal-dialog">
                                                <div class="modal-content" style="background: white">
                                                    <form action="{{ route('supprimerniveau', $niveauetude->id) }}">
                                                        ...
                                                        <div class="modal-body">
                                                            <p class="text-danger">Voulez-vous vraiment supprimer le
                                                                niveau d'étude <span
                                                                    class="text-info">{{ $niveauetude->niveauetude }}</span>
                                                                ?
                                                            </p>
