                ...
                <div class="col-lg-12 col-12">
                    <div class="bg-white boardaccueil">
                        ...
                        <div class="mt-4" style="margin-left: 170px!important;"><a type="btn" class="btn btn-primary"
                                href="{{ route('listeniveauetude') }}">Liste <i class="fa fa-book"></i></a> <a
                                type="btn" class="btn btn-secondary" href="javascript:void(0);"><i
                                    class="fa fa-backward"></i> Retour</a></div>
                    </div>
                </div>
            </div>
            <div class="row">
                        ...
                        <div class="inner ms-3">
                            ...
                            <form action="{{ route('ajoutniveauetude') }}" method="POST">
                                ...
                                <input type="text" class="form-control" name="niveauetude"
                                    placeholder="Saisir niveau d'etude"
                                    style="background-color: white; margin-bottom: 10px; color: black;" required>
                                <input type="submit" class="btn btn-success" value="Enregistrer">
                            </form>
                        </div>
                        <div style="margin-left: 200px!important;"><img src="{{ asset('dist/img/logobu2.png') }}"
