                ...
                <div class="col-lg-12 col-12">
                    <div class="bg-white boardaccueil">
                        ...
                        <div class="mt-4" style="margin-left: 170px!important;"><a type="btn" class="btn btn-primary"
                                href="{{ 'listenationalite' }}">Liste <i class="fa fa-book"></i></a> <a type="btn"
                    ...
                    <div class="small-box bg-white boardaccueil">
                        <div class="inner ms-3">
                            ...
                            <form action="{{ route('ajoutnationalite') }}" method="POST">
                                @csrf
                                <input type="text" class="form-control d-inline" name="nationalite"
                                    placeholder="Saisir nouvelle nationalite"
                                    style="background-color: white; margin-bottom: 10px; color: black;" required>
                                <input type="submit" class="btn btn-success" value="Enregistrer">
                            </form>
                        </div>
                        <div style="margin-left: 200px!important;"><img src="{{ asset('dist/img/pays.svg') }}"
