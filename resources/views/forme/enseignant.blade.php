      ...
      <div class="modal-body">
        <form action="{{route('enseignant.store')}}" method="POST">
          ...
          <label for="prenom" class="text-black">Prénom</label>
            <input type="text" class="form-control" name="prenom" placeholder="Prénom" style="background-color: white; margin-bottom: 10px; color: black;" required>
...
<label for="matiere" class="text-black">Matière enseignée</label>
    ...
    @endforeach
        ...
        <label for="anneeuniversitaire" class="text-black">Année Universitaire</label>
